...
class ApplicationMailerTest < ActionMailer::TestCase
  setup do
    ...
    ENV["SMTP_ADDRESS"] = "smtp.example.com.env"
    ENV["SMTP_PORT"] = "465"
    ENV["SMTP_USERNAME"] = "user@example.com.env"
    ENV["SMTP_PASSWORD"] = "password.env"
    ENV["EMAIL_SENDER"] = "notification@example.com.env"
    ...
    ApplicationMailer.define_method(:test_email) do
      mail(to: "user@example.com", subject: "Test email subject", body: "Test email body")
    end
  ...
  test "should return ENV config when self hosting is not enabled" do
    ...
    email = ApplicationMailer.test_email.deliver_now
    debugger
    assert_equal @smtp_settings_from_env, email.delivery_method.settings
  ...
  test "should return setting config when self hosting is enabled" do
    ...
    email = ApplicationMailer.test_email.deliver_now
    assert_equal @smtp_settings_from_settings, email.delivery_method.settings
