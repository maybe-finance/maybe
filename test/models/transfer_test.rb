...
class TransferTest < ActiveSupport::TestCase
  ...
  test "cannot create duplicate transfer with same inflow and outflow transactions" do
    ...
    assert_includes duplicate_transfer.errors.full_messages, "Inflow transaction and outflow transaction combination already exists in another transfer"
  end
