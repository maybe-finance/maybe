...
class Account::Balance::CalculatorTest < ActiveSupport::TestCase
  ...
  private 
    def calculate(start_date: nil, is_partial_sync: false, strategy: :chronological)
      Account::Balance::Calculator.new(@account, start_date).calculate(is_partial_sync:, strategy:)
    end
end
