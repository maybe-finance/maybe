...
class Family::AutoTransferMatchableTest < ActiveSupport::TestCase
  ...
  test "does not match multi-currency transfer with zero exchange rate" do
    ExchangeRate.create!(
      from_currency: "USD",
      to_currency: "CAD",
    ...
    create_transaction(date: 10.days.ago.to_date, account: @depository, amount: 500)
    create_transaction(date: 10.days.ago.to_date, account: @credit_card, amount: -700, currency: "CAD")
