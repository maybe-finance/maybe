module FormsHelper
  ...
  def period_select(form:, selected:, classes: "border border-secondary bg-container-inset rounded-lg text-xs sm:text-sm pr-7 cursor-pointer text-primary focus:outline-hidden focus:ring-0")
