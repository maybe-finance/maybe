class Balance::SyncCache
  ...
  private
    ...
    def find_rate_by_cache(amount_money, other_currency, date: Date.current, fallback_rate: 1)
      ...
      exchange_rate = exchange_rates[[ iso_code, date ]]&.last&.rate ||
    ...
    def exchange_rates
      ...
      @exchange_rates ||= ExchangeRate
        .where(from_currency: all_currencies, to_currency: account.currency)
