class Demo::Generator
  ...
  private
    ...
    def load_securities!
      ...
      Security.create! ticker: "UNKNOWN", name: "Unknown Demo Stock", unknown: true

      securities = [
        { ticker: "AAPL", exchange_mic: "XNGS", name: "Apple Inc.", reference_price: 210 },
        { ticker: "TM", exchange_mic: "XNYS", name: "Toyota Motor Corporation", reference_price: 202 },
        { ticker: "MSFT", exchange_mic: "XNGS", name: "Microsoft Corporation", reference_price: 455 }
      ]
